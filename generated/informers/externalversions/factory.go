...
import (
	...
	bmc "github.com/s-urbaniak/tinkerbell-client-go/generated/informers/externalversions/bmc"
	internalinterfaces "github.com/s-urbaniak/tinkerbell-client-go/generated/informers/externalversions/internalinterfaces"
	tinkerbell "github.com/s-urbaniak/tinkerbell-client-go/generated/informers/externalversions/tinkerbell"
...
type SharedInformerFactory interface {
	...
	Bmc() bmc.Interface
	Tinkerbell() tinkerbell.Interface
}

func (f *sharedInformerFactory) Bmc() bmc.Interface {
	return bmc.New(f, f.namespace, f.tweakListOptions)
}

func (f *sharedInformerFactory) Tinkerbell() tinkerbell.Interface {
	return tinkerbell.New(f, f.namespace, f.tweakListOptions)
}
