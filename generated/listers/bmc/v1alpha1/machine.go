...
type MachineLister interface {
	...
	List(selector labels.Selector) (ret []*bmcv1alpha1.Machine, err error)
...
type machineLister struct {
	listers.ResourceIndexer[*bmcv1alpha1.Machine]
}

// NewMachineLister returns a new MachineLister.
func NewMachineLister(indexer cache.Indexer) MachineLister {
	return &machineLister{listers.New[*bmcv1alpha1.Machine](indexer, bmcv1alpha1.GroupVersion.WithResource("machine").GroupResource())}
}

// Machines returns an object that can list and get Machines.
func (s *machineLister) Machines(namespace string) MachineNamespaceLister {
	return machineNamespaceLister{listers.NewNamespaced[*bmcv1alpha1.Machine](s.ResourceIndexer, namespace)}
}
...
type MachineNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*bmcv1alpha1.Machine, error)
