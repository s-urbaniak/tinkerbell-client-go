...
# The input packages mirror only root type names and status presence. Generated
# imports are rebound to the published API module below; no API types are copied.
"$GOBIN/client-gen" \
